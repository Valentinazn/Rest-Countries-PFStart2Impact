  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="
       focus:outline-none sm:placeholder:text-[14px] placeholder:text-xs placeholder:leading-[20px] placeholder:font-[400] placeholder:text-darkGray dark:placeholder:text-white bg-transparent"
        type="text"
